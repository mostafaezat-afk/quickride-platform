...
const getFare = async (pickup, destination) => {
  ...
  // Helper function to calculate fare for a vehicle type
  const calculateVehicleFare = (type) => Math.round(
    baseFare[type] +
  ...
  const fare = {
    ...
    bike: calculateVehicleFare("bike"),
    tuktuk: calculateVehicleFare("tuktuk"),
    torsicle: calculateVehicleFare("torsicle"),
    delivery: calculateVehicleFare("delivery"),
  };
