...
import { ChevronLeft, CircleUserRound, History, Menu, X } from "lucide-react";
...
function Sidebar() {
  ...
  return (
    <>
      <div
        className="m-3 mt-4 absolute left-0 top-0 z-20 cursor-pointer bg-white p-1 rounded"
        onClick={() => {
      ...
      >
        <div className="select-none">
          ...
          >
            <div className="flex gap-3">
              <CircleUserRound /> <h1>تعديل الملف الشخصي</h1>
            </div>
            <div>
              <ChevronLeft />
            </div>
        ...
        <Button title={"تسجيل الخروج"} classes={"bg-red-600"} fun={logout} />
      </div>
    </>
  );
}
